...
const Footer = () => {
  return (
    <footer className="bg-[#e2feff] py-8 border-t w-full border-black">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8 md:ml-16 md:mr-16 lg:ml-16 lg:mr-16">
          <div>
        ...
        <div className="mt-8">
          ...
          <form className="flex flex-col lg:flex-row md:flex-row items-center md:space-x-4">
            <input
              type="email"
        ...
        <div>
        <p className="mt-8 border-t  border-black md:border-t flex flex-col items-center">
